...
import com.fluxtion.dataflow.builder.flowfunction.*;
import com.fluxtion.dataflow.runtime.DataFlow;
import com.fluxtion.dataflow.runtime.context.buildtime.GeneratorNodeCollection;
import com.fluxtion.dataflow.runtime.flowfunction.function.QuinPushFunction;
...
import com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByHashMap;
...
import com.fluxtion.dataflow.runtime.event.Signal;
import com.fluxtion.dataflow.runtime.node.DefaultEventHandlerNode;
import com.fluxtion.dataflow.runtime.node.NamedFeedEventHandlerNode;
import com.fluxtion.dataflow.runtime.node.NamedFeedTopicFilteredEventHandlerNode;
...
public interface DataFlowBuilder {
    ...
    /**
     * Subscribes to {@link NamedFeedEvent}'s published by an {@link com.fluxtion.dataflow.runtime.input.EventFeed} service
     * registered with feedName.
     *
     * @param feedName the service name of the registered {@link com.fluxtion.dataflow.runtime.input.EventFeed}
     * @return An {@link FlowBuilder} that can used to construct stream processing logic
     */
    ...
    /**
     * Subscribes to events of type {@link NamedFeedEvent<T>} published by an {@link com.fluxtion.dataflow.runtime.input.EventFeed} service
     * registered with feedName.
     *
     * @param feedName the service name of the registered {@link com.fluxtion.dataflow.runtime.input.EventFeed}
    ...
    static <T> FlowBuilder<T> subscribeToNode(T source) {
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.NodeToFlowFunction<>(source));
    }
    ...
    static <R> FlowBuilder<R> subscribeToNodeProperty(SerializableSupplier<R> propertySupplier) {
        ...
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.NodePropertyToFlowFunction<>(propertySupplier));
    }
    ...
    static <T, A, B> FlowBuilder<T> push(
        ...
        com.fluxtion.dataflow.runtime.flowfunction.function.BiPushFunction<T, A, B> pushFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.BiPushFunction<>(
                instancePushMethod,
    ...
    static <T, A, B, C> FlowBuilder<T> push(
        ...
        com.fluxtion.dataflow.runtime.flowfunction.function.TriPushFunction<T, A, B, C> pushFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.TriPushFunction<>(
                instancePushMethod,
                flowBuilderA.flowSupplier(),
                flowBuilderB.flowSupplier(),
    ...
    static <T, A, B, C, D> FlowBuilder<T> push(
        ...
        com.fluxtion.dataflow.runtime.flowfunction.function.QuadPushFunction<T, A, B, C, D> pushFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.QuadPushFunction<>(
                instancePushMethod,
                flowBuilderA.flowSupplier(),
                flowBuilderB.flowSupplier(),
                flowBuilderC.flowSupplier(),
    ...
    static <T, A, B, C, D, E> FlowBuilder<T> push(
        ...
        com.fluxtion.dataflow.runtime.flowfunction.function.QuinPushFunction<T, A, B, C, D, E> pushFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.QuinPushFunction<>(
                instancePushMethod,
                flowBuilderA.flowSupplier(),
                flowBuilderB.flowSupplier(),
                flowBuilderC.flowSupplier(),
    ...
    static <T, A, B, C, D, E, F> FlowBuilder<T> push(
        ...
        com.fluxtion.dataflow.runtime.flowfunction.function.SextPushFunction<T, A, B, C, D, E, F> pushFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.SextPushFunction<>(
                instancePushMethod,
                flowBuilderA.flowSupplier(),
                flowBuilderB.flowSupplier(),
                flowBuilderC.flowSupplier(),
    ...
    static <T, A, B, C, D, E> FlowBuilder<T> push(
            ...
            FlowDataSupplier<? extends FlowSupplier<D>> flowBuilderD,
            FlowDataSupplier<? extends FlowSupplier<E>> flowBuilderE) {
        com.fluxtion.dataflow.runtime.flowfunction.function.QuinPushFunction<T, A, B, C, D, E> pushFunction = new QuinPushFunction<>(
                classPushMethod,
                flowBuilderA.flowSupplier(),
                flowBuilderB.flowSupplier(),
                flowBuilderC.flowSupplier(),
