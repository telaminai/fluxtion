...
import com.fluxtion.dataflow.builder.generation.serialiser.FieldSerializer;
...
import com.fluxtion.dataflow.builder.generation.model.Field.MappedField;
import com.fluxtion.dataflow.builder.filter.DefaultFilterDescriptionProducer;
import com.fluxtion.dataflow.builder.filter.EventHandlerFilterOverride;
import com.fluxtion.dataflow.builder.filter.FilterDescription;
import com.fluxtion.dataflow.builder.filter.FilterDescriptionProducer;
import com.fluxtion.dataflow.builder.generation.util.SuperMethodAnnotationScannerCache;
import com.fluxtion.dataflow.runtime.annotations.*;
import com.fluxtion.dataflow.runtime.annotations.builder.AssignToField;
import com.fluxtion.dataflow.runtime.annotations.builder.ConstructorArg;
...
import static com.fluxtion.dataflow.builder.generation.model.ConstructorMatcherPredicate.*;
...
//                if (Modifier.isStatic(input.getModifiers()) || (Modifier.isPublic(input.getModifiers()) && !Modifier.isFinal(input.getModifiers()))) {
                ...
                try {
                    ...
                    if (directParents.contains(parent)) {
                        ...
                        MappedField collectionField = new MappedField(fieldName, collectionClass);
    ...
    private void lifeCycleHandlers() throws Exception {
        ...
        for (Object object : objectTopologicalHandler) {
            ...
            for (Method method : methodList) {
                if (annotationScannerCache.annotationInHierarchy(method, Initialise.class)) {
                ...
                if (annotationScannerCache.annotationInHierarchy(method, Start.class)) {
                ...
                if (annotationScannerCache.annotationInHierarchy(method, StartComplete.class)) {
                ...
                if (annotationScannerCache.annotationInHierarchy(method, TearDown.class)) {
                ...
                if (annotationScannerCache.annotationInHierarchy(method, Stop.class)) {
        ...
        for (Object object : topologicalHandlers) {
            ...
            Method[] methodList = object.getClass().getMethods();
            for (Method method : methodList) {
                if (annotationScannerCache.annotationInHierarchy(method, OnBatchEnd.class)) {
                ...
                if (annotationScannerCache.annotationInHierarchy(method, OnBatchPause.class)) {
                    //revered for the batch callbacks
                ...
                if (annotationScannerCache.annotationInHierarchy(method, AfterEvent.class)) {
                    //revered for the batch callbacks
                ...
                if (annotationScannerCache.annotationInHierarchy(method, OnTrigger.class)) {
        ...
        EventCallList(Object instance, Method onEventMethod, String exportedMethodName, boolean propagate) throws Exception {
            ...
            for (int i = 0; i < sortedDependents.size(); i++) {
                ...
                for (Method method : methodList) {
                    ...
                    if (annotationScannerCache.annotationInHierarchy(method, AfterTrigger.class) && i > 0) {
                        postDispatchMethods.add(new CbMethodHandle(method, object, name));
                    }
                }
            }
