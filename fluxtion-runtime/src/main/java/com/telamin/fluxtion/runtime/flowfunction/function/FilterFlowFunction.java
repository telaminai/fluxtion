...
public class FilterFlowFunction<T, S extends FlowFunction<T>> extends AbstractFlowFunction<T, T, S> {
    ...
    public FilterFlowFunction(S inputEventStream, SerializableFunction<T, Boolean> filterFunction, MethodReferenceInfo methodReferenceInfo) {
    ...
    public static class IntFilterFlowFunction extends AbstractFlowFunction<Integer, Integer, IntFlowFunction> implements IntFlowFunction {
        ...
        public IntFilterFlowFunction(IntFlowFunction inputEventStream, SerializableIntFunction<Boolean> filterFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, filterFunction, methodReferenceInfo);
            this.filterFunction = filterFunction;
            auditInfo = methodReferenceInfo.getAuditName();
        }
    ...
    public static class DoubleFilterFlowFunction extends AbstractFlowFunction<Double, Double, DoubleFlowFunction> implements DoubleFlowFunction {
        ...
        public DoubleFilterFlowFunction(DoubleFlowFunction inputEventStream, SerializableDoubleFunction<Boolean> filterFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, filterFunction, methodReferenceInfo);
            this.filterFunction = filterFunction;
            auditInfo = methodReferenceInfo.getAuditName();
        }
    ...
    public static class LongFilterFlowFunction extends AbstractFlowFunction<Long, Long, LongFlowFunction> implements LongFlowFunction {
        ...
        public LongFilterFlowFunction(LongFlowFunction inputEventStream, SerializableLongFunction<Boolean> filterFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, filterFunction, methodReferenceInfo);
            this.filterFunction = filterFunction;
            auditInfo = methodReferenceInfo.getAuditName();
        }
