...
public abstract class MapFlowFunction<T, R, S extends FlowFunction<T>> extends AbstractFlowFunction<T, R, S> {
    ...
    protected transient boolean defaultValueSupplier;
    ...
    public MapFlowFunction(S inputEventStream, MethodReferenceReflection methodReferenceReflection) {
        ...
        if (methodReferenceReflection != null) {
            ...
            defaultValueSupplier = DefaultValueSupplier.class.isAssignableFrom(method.getDeclaringClass());
        }
    }

    /**
     * Closed-world constructor — audit label and default-value-supplier flag are
     * supplied by the generator (no runtime {@code SerializedLambda}).
     */
    public MapFlowFunction(S inputEventStream, MethodReferenceReflection methodReferenceReflection, MethodReferenceInfo methodReferenceInfo) {
        super(inputEventStream, methodReferenceReflection, methodReferenceInfo);
        this.auditInfo = methodReferenceInfo.getAuditName();
        this.defaultValueSupplier = methodReferenceInfo.isDefaultValueSupplier();
    }
...
//            resetOperation();
    ...
    public boolean hasDefaultValue() {
        return defaultValue != null | defaultValueSupplier;
    }
    ...
    public static class MapRef2RefFlowFunction<T, R, S extends FlowFunction<T>> extends MapFlowFunction<T, R, S> {
        ...
        public MapRef2RefFlowFunction(S inputEventStream, SerializableFunction<T, R> mapFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, mapFunction, methodReferenceInfo);
            this.mapFunction = mapFunction;
        }
    ...
    public static class MapInt2RefFlowFunction<R> extends MapFlowFunction<Integer, R, IntFlowFunction> {
        ...
        public MapInt2RefFlowFunction(IntFlowFunction inputEventStream, SerializableIntFunction<R> mapFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, mapFunction, methodReferenceInfo);
            this.mapFunction = mapFunction;
        }
    ...
    public static class MapDouble2RefFlowFunction<R> extends MapFlowFunction<Double, R, DoubleFlowFunction> {
        ...
        public MapDouble2RefFlowFunction(DoubleFlowFunction inputEventStream, SerializableDoubleFunction<R> mapFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, mapFunction, methodReferenceInfo);
            this.mapFunction = mapFunction;
        }
    ...
    public static class MapLong2RefFlowFunction<R> extends MapFlowFunction<Long, R, LongFlowFunction> {
        ...
        public MapLong2RefFlowFunction(LongFlowFunction inputEventStream, SerializableLongFunction<R> mapFunction, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, mapFunction, methodReferenceInfo);
            this.mapFunction = mapFunction;
        }
    ...
    abstract static class AbstractMapToIntFlowFunction<T, S extends FlowFunction<T>> extends MapFlowFunction<T, Integer, S> implements IntFlowFunction {
        ...
        public AbstractMapToIntFlowFunction(S inputEventStream, MethodReferenceReflection method, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, method, methodReferenceInfo);
        }
    ...
    public static class MapRef2ToIntFlowFunction<R, S extends FlowFunction<R>> extends AbstractMapToIntFlowFunction<R, S> {
        ...
        public MapRef2ToIntFlowFunction(S inputEventStream, SerializableToIntFunction<R> intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapInt2ToIntFlowFunction extends AbstractMapToIntFlowFunction<Integer, IntFlowFunction> {
        ...
        public MapInt2ToIntFlowFunction(IntFlowFunction inputEventStream, SerializableIntUnaryOperator intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapDouble2ToIntFlowFunction extends AbstractMapToIntFlowFunction<Double, DoubleFlowFunction> {
        ...
        public MapDouble2ToIntFlowFunction(DoubleFlowFunction inputEventStream, SerializableDoubleToIntFunction intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapLong2ToIntFlowFunction extends AbstractMapToIntFlowFunction<Long, LongFlowFunction> {
        ...
        public MapLong2ToIntFlowFunction(LongFlowFunction inputEventStream, SerializableLongToIntFunction intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    abstract static class AbstractMapToDoubleFlowFunction<T, S extends FlowFunction<T>> extends MapFlowFunction<T, Double, S> implements DoubleFlowFunction {
        ...
        public AbstractMapToDoubleFlowFunction(S inputEventStream, MethodReferenceReflection method, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, method, methodReferenceInfo);
        }
    ...
    public static class MapRef2ToDoubleFlowFunction<R, S extends FlowFunction<R>> extends AbstractMapToDoubleFlowFunction<R, S> {
        ...
        public MapRef2ToDoubleFlowFunction(S inputEventStream, SerializableToDoubleFunction<R> intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapDouble2ToDoubleFlowFunction extends AbstractMapToDoubleFlowFunction<Double, DoubleFlowFunction> {
        ...
        public MapDouble2ToDoubleFlowFunction(DoubleFlowFunction inputEventStream, SerializableDoubleUnaryOperator intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapInt2ToDoubleFlowFunction extends AbstractMapToDoubleFlowFunction<Integer, IntFlowFunction> {
        ...
        public MapInt2ToDoubleFlowFunction(IntFlowFunction inputEventStream, SerializableIntToDoubleFunction intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapLong2ToDoubleFlowFunction extends AbstractMapToDoubleFlowFunction<Long, LongFlowFunction> {
        ...
        public MapLong2ToDoubleFlowFunction(LongFlowFunction inputEventStream, SerializableLongToDoubleFunction intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    abstract static class AbstractMapToLongFlowFunction<T, S extends FlowFunction<T>> extends MapFlowFunction<T, Long, S> implements LongFlowFunction {
        ...
        public AbstractMapToLongFlowFunction(S inputEventStream, MethodReferenceReflection method, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, method, methodReferenceInfo);
        }
    ...
    public static class MapRef2ToLongFlowFunction<R, S extends FlowFunction<R>> extends AbstractMapToLongFlowFunction<R, S> {
        private final SerializableToLongFunction<R> intUnaryOperator;

        public MapRef2ToLongFlowFunction(S inputEventStream, SerializableToLongFunction<R> intUnaryOperator) {
            super(inputEventStream, intUnaryOperator);
            this.intUnaryOperator = intUnaryOperator;
        }

        public MapRef2ToLongFlowFunction(S inputEventStream, SerializableToLongFunction<R> intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapLong2ToLongFlowFunction extends AbstractMapToLongFlowFunction<Long, LongFlowFunction> {
        ...
        public MapLong2ToLongFlowFunction(LongFlowFunction inputEventStream, SerializableLongUnaryOperator intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapInt2ToLongFlowFunction extends AbstractMapToLongFlowFunction<Integer, IntFlowFunction> {
        ...
        public MapInt2ToLongFlowFunction(IntFlowFunction inputEventStream, SerializableIntToLongFunction intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
    ...
    public static class MapDouble2ToLongFlowFunction extends AbstractMapToLongFlowFunction<Double, DoubleFlowFunction> {
        ...
        public MapDouble2ToLongFlowFunction(DoubleFlowFunction inputEventStream, SerializableDoubleToLongFunction intUnaryOperator, MethodReferenceInfo methodReferenceInfo) {
            super(inputEventStream, intUnaryOperator, methodReferenceInfo);
            this.intUnaryOperator = intUnaryOperator;
        }
