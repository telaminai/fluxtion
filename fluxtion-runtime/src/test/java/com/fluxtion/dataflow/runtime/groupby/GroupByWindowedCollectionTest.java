package com.fluxtion.dataflow.runtime.groupby;
...
public class GroupByWindowedCollectionTest {
    ...
    Supplier<GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction>> supplier =
            () -> new GroupByFlowFunctionWrapper<>(Data::getKey, Data::getIntValue, IntSumFlowFunction::new);

    @Test
    public void testMap() {
        GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction> groupCount = supplier.get();
    ...
    public void testCombine() {
        GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction> group1 = supplier.get();
        GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction> group2 = supplier.get();
        GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction> group3 = supplier.get();
    ...
    public void testDeduct() {
        GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction> aggregate = supplier.get();
        GroupByFlowFunctionWrapper<Data, String, Integer, Integer, IntSumFlowFunction> group1 = supplier.get();
