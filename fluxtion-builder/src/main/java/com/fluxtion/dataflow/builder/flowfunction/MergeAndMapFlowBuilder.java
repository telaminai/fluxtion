...
import com.fluxtion.dataflow.runtime.flowfunction.function.MergeMapFlowFunction;
import com.fluxtion.dataflow.runtime.flowfunction.function.MergeMapToNodeFlowFunction;
import com.fluxtion.dataflow.runtime.flowfunction.function.MergeProperty;
...
public class MergeAndMapFlowBuilder<T> {
    ...
    public static <T1, R> MergeInput<T1, R> requiredMergeInput(FlowBuilder<R> flow,
        ...
        return new MergeInput<>(true, flow, setter);
    }

    public static <T1, R> MergeInput<T1, R> optionalMergeInput(FlowBuilder<R> flow,
                                                               LambdaReflection.SerializableBiConsumer<T1, R> setter) {
        return new MergeInput<>(false, flow, setter);
    }
