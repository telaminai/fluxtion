...
import com.fluxtion.dataflow.runtime.flowfunction.aggregate.function.AggregateFlowFunctionWrapper;
...
import com.fluxtion.dataflow.runtime.flowfunction.aggregate.function.TumblingWindow;
import com.fluxtion.dataflow.runtime.flowfunction.function.BinaryMapFlowFunction.BinaryMapToRefFlowFunction;
import com.fluxtion.dataflow.runtime.flowfunction.function.LookupFlowFunction;
...
public class FlowBuilder<T> extends AbstractFlowBuilder<T, FlowBuilder<T>> implements FlowDataSupplier<FlowSupplier<T>> {
    ...
    public FlowBuilder<T> merge(FlowBuilder<? extends T> streamToMerge) {
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.MergeFlowFunction<>(eventStream, streamToMerge.eventStream));
    }
    ...
    public FlowBuilder<T> merge(FlowBuilder<? extends T> streamToMerge, FlowBuilder<? extends T>... streamsToMerge) {
        ...
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.MergeFlowFunction<>(mergeList));
    }

    public <R> FlowBuilder<R> flatMap(SerializableFunction<T, Iterable<R>> iterableFunction) {
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapFlowFunction<>(eventStream, iterableFunction));
    }

    public <R> FlowBuilder<R> flatMap(SerializableFunction<T, Iterable<R>> iterableFunction, String flatMapCompleteSignal) {
        com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapFlowFunction<T, R, TriggeredFlowFunction<T>> flatMapIteratorFlowFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapFlowFunction<>(eventStream, iterableFunction);
    ...
    public <R> FlowBuilder<R> flatMapFromIterator(SerializableFunction<T, Iterator<R>> iterableFunction) {
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapIteratorFlowFunction<>(eventStream, iterableFunction));
    }
    ...
    public <R> FlowBuilder<R> flatMapFromIterator(SerializableFunction<T, Iterator<R>> iterableFunction, String flatMapCompleteSignal) {
        com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapIteratorFlowFunction<T, R, TriggeredFlowFunction<T>> flatMapIteratorFlowFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapIteratorFlowFunction<>(eventStream, iterableFunction);
        flatMapIteratorFlowFunction.setFlatMapCompleteSignal(flatMapCompleteSignal);
        return new FlowBuilder<>(flatMapIteratorFlowFunction);
    }

    public <R> FlowBuilder<R> flatMapFromArray(SerializableFunction<T, R[]> iterableFunction) {
        return new FlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapArrayFlowFunction<>(eventStream, iterableFunction));
    }

    public <R> FlowBuilder<R> flatMapFromArray(SerializableFunction<T, R[]> iterableFunction, String flatMapCompleteSignal) {
        com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapArrayFlowFunction<T, R, TriggeredFlowFunction<T>> flatMapIteratorFlowFunction = new com.fluxtion.dataflow.runtime.flowfunction.function.FlatMapArrayFlowFunction<>(eventStream, iterableFunction);
        flatMapIteratorFlowFunction.setFlatMapCompleteSignal(flatMapCompleteSignal);
        return new FlowBuilder<>(flatMapIteratorFlowFunction);
    }
    ...
    groupBy(SerializableFunction<T, K1> keyFunction,
        ...
        com.fluxtion.dataflow.runtime.flowfunction.function.MapFlowFunction<T, com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupBy<K1, A>, TriggeredFlowFunction<T>> x = new MapRef2RefFlowFunction<>(eventStream,
                new com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByFlowFunctionWrapper<>(keyFunction, valueFunction, aggregateFunctionSupplier)::aggregate)
     ...
     */
    @SafeVarargs
    public final GroupByFlowBuilder<com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey<T>, T> groupByFields(
            SerializableFunction<T, ?>... keyFunctions) {
        return groupBy(com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey.build(keyFunctions));
    }
     ...
     */
    @SafeVarargs
    public final <A, F extends AggregateFlowFunction<T, A, F>> GroupByFlowBuilder<com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey<T>, A> groupByFieldsAggregate(
            SerializableSupplier<F> aggregateFunctionSupplier,
            SerializableFunction<T, ?>... keyFunctions) {
        return groupBy(com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey.build(keyFunctions), aggregateFunctionSupplier);
    }
     ...
     */
    @SafeVarargs
    public final <V> GroupByFlowBuilder<com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey<T>, V> groupByFieldsAndGet(
            SerializableFunction<T, V> valueFunction,
            SerializableFunction<T, ?>... keyFunctions) {
        return groupBy(com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey.build(keyFunctions), valueFunction);
    }
     ...
     */
    @SafeVarargs
    public final <V, A, F extends AggregateFlowFunction<V, A, F>> GroupByFlowBuilder<com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey<T>, A> groupByFieldsGetAndAggregate(
            SerializableFunction<T, V> valueFunction,
            SerializableSupplier<F> aggregateFunctionSupplier,
            SerializableFunction<T, ?>... keyFunctions) {
        return groupBy(com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey.build(keyFunctions), valueFunction, aggregateFunctionSupplier);
    }
     ...
     */
    @SafeVarargs
    public final GroupByFlowBuilder<com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey<T>, List<T>> groupByToList(SerializableFunction<T, ?>... keyFunctions) {
     ...
     */
    @SafeVarargs
    public final GroupByFlowBuilder<com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByKey<T>, Set<T>> groupByToSet(SerializableFunction<T, ?>... keyFunctions) {
    ...
    groupByTumbling(SerializableFunction<T, K> keyFunction,
        ...
        return new GroupByFlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByTumblingWindow<>(
                eventStream,
    ...
    groupBySliding(SerializableFunction<T, K> keyFunction,
                   ...
                   int bucketSizeMillis,
                   int numberOfBuckets) {
        return new GroupByFlowBuilder<>(new com.fluxtion.dataflow.runtime.flowfunction.groupby.GroupByTimedSlidingWindow<>(
                eventStream,
                aggregateFunctionSupplier,
                keyFunction,
                valueFunction,
