...
import com.telamin.fluxtion.runtime.flowfunction.function.MapFlowFunction.MapRef2ToDoubleFlowFunction;
import com.telamin.fluxtion.runtime.flowfunction.function.MapFlowFunction.MapRef2ToIntFlowFunction;
import com.telamin.fluxtion.runtime.flowfunction.function.MapFlowFunction.MapRef2ToLongFlowFunction;
import com.telamin.fluxtion.runtime.flowfunction.function.NotifyFlowFunction;
import com.telamin.fluxtion.runtime.flowfunction.helpers.InternalEventDispatcher;
import com.telamin.fluxtion.runtime.flowfunction.helpers.Peekers;
import com.telamin.fluxtion.runtime.flowfunction.helpers.Predicates.PredicateWrapper;
...
public abstract class AbstractFlowBuilder<T, B extends AbstractFlowBuilder<T, B>> {
    ...
    public B filter(SerializableFunction<T, Boolean> filterFunction) {
        return connect(new com.telamin.fluxtion.runtime.flowfunction.function.FilterFlowFunction<>(eventStream, filterFunction));
    }
    ...
    public <P> B filterByProperty(SerializableFunction<T, P> accessor, SerializableFunction<P, Boolean> filterFunction) {
        return connect(new com.telamin.fluxtion.runtime.flowfunction.function.FilterByPropertyFlowFunction<>(eventStream, accessor, filterFunction));
    }
    ...
    public <S> B filter(
        ...
        return connect(
                new com.telamin.fluxtion.runtime.flowfunction.function.FilterDynamicFlowFunction<>(eventStream, secondArgument.eventStream, predicate));
    }
    ...
    public <P, S> B filterByProperty(
            ...
            FlowBuilder<S> secondArgument) {
        return connect(
                new com.telamin.fluxtion.runtime.flowfunction.function.FilterByPropertyDynamicFlowFunction<>(eventStream, accessor, secondArgument.eventStream, predicate));
    }
    ...
    protected <R, E> E mapOnNotifyBase(R target) {
        return (E) connectMap(new com.telamin.fluxtion.runtime.flowfunction.function.MapOnNotifyFlowFunction<>(eventStream, target));
    }
    ...
    public final B push(SerializableConsumer<T>... pushFunctions) {
        ...
        for (SerializableConsumer<T> pushFunction : pushFunctions) {
            target = connect(new com.telamin.fluxtion.runtime.flowfunction.function.PushFlowFunction<>(eventStream, pushFunction));
        }
        return target;
    }
    ...
    public B processAsNewGraphEvent() {
        return connect(new com.telamin.fluxtion.runtime.flowfunction.function.PeekFlowFunction<>(eventStream, new InternalEventDispatcher()::dispatchToGraph));
    }

    public B peek(SerializableConsumer<T> peekFunction) {
        return connect(new com.telamin.fluxtion.runtime.flowfunction.function.PeekFlowFunction<>(eventStream, peekFunction));
    }
