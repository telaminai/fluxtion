...
import com.telamin.fluxtion.builder.generation.GeneratorNodeCollectionImpl;
import com.telamin.fluxtion.runtime.callback.InstanceCallbackEvent;
import lombok.Data;
...
public class GenerationContext {
    ...
    public static void inLineContext() {
        if (SINGLETON == null) {
            GenerationContext.setupStaticContext("pkg" + nextId(), "Processor" + nextId(), new File(JAVA_GEN_DIR), new File(RESOURCE_DIR));
        }
    }
    ...
    private GenerationContext(String packageName, String sepClassName, File outputDirectory, File resourcesRootDirectory, File buildOutputDirectory) {
        ...
        GeneratorNodeCollectionImpl.resetGenerationContext();
    }
