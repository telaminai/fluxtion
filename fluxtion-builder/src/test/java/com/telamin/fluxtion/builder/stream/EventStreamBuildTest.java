...
public class EventStreamBuildTest extends MultipleSepTargetInProcessTest {
    ...
    public void wrapNodeAsStreamTest() {
        sep(c -> DataFlowBuilder.subscribeToNode(new MyStringHandler())
    ...
    public void nodePropertyStreamTest() {
        sep(c -> {
            ...
            subscribeToNodeProperty(myStringHandler::getParsedNumber)
...
//        System.out.println(notifyTarget);
    ...
    public void testMapToSet() {
        sep(c -> subscribe(String.class).mapToSet().id("set"));
    ...
    public void testMapToSetFromProperty() {
        sep(c -> subscribe(GroupByTest.Data.class).mapToSet(GroupByTest.Data::getName).id("set"));
        HashSet<String> set = new HashSet<>();
        set.add("test");
    ...
    public void testMapToList() {
        sep(c -> subscribe(String.class).mapToList().id("list"));
    ...
    public void testMapToList_MaxElements() {
        sep(c -> subscribe(String.class).mapToList(2).id("list"));
        List<String> list = new ArrayList<>();
        list.add("test");
        list.add("test");
        onEvent("test");
    ...
    public void testMapToListFromProperty() {
        sep(c -> subscribe(GroupByTest.Data.class).mapToList(GroupByTest.Data::getName).id("list"));
        List<String> list = new ArrayList<>();
        list.add("test");
        list.add("test");
        onEvent(new GroupByTest.Data("test", 22));
    ...
    public void testMapToListFromProperty_MaxElements() {
        sep(c -> subscribe(GroupByTest.Data.class).mapToList(GroupByTest.Data::getName, 2).id("list"));
        List<String> list = new ArrayList<>();
        list.add("test1");
        list.add("test2");
