package com.telamin.fluxtion.builder.stream.lookup;
...
import com.telamin.fluxtion.runtime.flowfunction.lookup.IntLookupPredicate;
import com.telamin.fluxtion.runtime.flowfunction.lookup.LongLookupPredicate;
...
public class StreamLookupTest extends MultipleSepTargetInProcessTest {
    ...
    public void testLongLookup() {
        ...
        sep(c -> {
            DataFlowBuilder.subscribe(MarketUpdate.class)
                    .filterByProperty(
