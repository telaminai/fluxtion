...
public class MergeMapStreamTest extends MultipleSepTargetInProcessTest {
    ...
    public void mergeTestBasic() {
        sep(c -> DataFlowBuilder.mergeMap(
                MergeAndMapFlowBuilder.of(MyData::new).required(subscribe(String.class), MyData::setValue)
    ...
    public void mergeTestBasicWithHelper() {
        sep(c -> {
            MergeAndMapFlowBuilder
                    .merge(MyData::new, MergeAndMapFlowBuilder.requiredMergeInput(subscribe(String.class), MyData::setValue))
                    .push(new ResultsHolder()::setMyData);
        });
        ResultsHolder resultsHolder = getField(ResultsHolder.NAME);
        onEvent("hello world");
    ...
    public void mergeTwoRequired_Helper_PropertiesTest() {
        sep(c -> {
            ...
            MergeAndMapFlowBuilder.merge(MyData::new,
                            MergeAndMapFlowBuilder.requiredMergeInput(subscribe(String.class), MyData::setValue),
                            MergeAndMapFlowBuilder.requiredMergeInput(subscribe(Integer.class), MyData::setIntValue))
                    .push(new ResultsHolder()::setMyData);
    ...
    public void mergeRequiredAndOptional_Helper_PropertiesTest() {
        sep(c -> {
            DataFlowBuilder.mergeMap(MyData::new,
                            MergeAndMapFlowBuilder.requiredMergeInput(subscribe(String.class), MyData::setValue),
                            MergeAndMapFlowBuilder.optionalMergeInput(subscribe(Integer.class), MyData::setIntValue))
                    .push(new ResultsHolder()::setMyData);
    ...
    public void mergeToKnownInstance_PropertiesTest() {
        sep(c -> {
            ...
            DataFlowBuilder.mergeMapToNode(myData,
                            MergeAndMapFlowBuilder.requiredMergeInput(subscribe(String.class), MyData::setValue),
                            MergeAndMapFlowBuilder.optionalMergeInput(subscribe(Integer.class), MyData::setIntValue))
                    .push(new ResultsHolder()::setMyData);
