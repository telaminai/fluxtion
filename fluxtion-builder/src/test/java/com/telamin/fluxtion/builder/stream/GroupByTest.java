...
import com.telamin.fluxtion.builder.flowfunction.GroupByFunction;
import com.telamin.fluxtion.builder.flowfunction.JoinFlowBuilder;
import com.telamin.fluxtion.builder.stream.EventStreamBuildTest.KeyedData;
import com.telamin.fluxtion.builder.stream.EventStreamBuildTest.MergedType;
import com.telamin.fluxtion.builder.stream.EventStreamBuildTest.MyIntFilter;
...
import static com.telamin.fluxtion.builder.DataFlowBuilder.*;
...
public class GroupByTest extends MultipleSepTargetInProcessTest {
    ...
    public void joinGroupByTestSimple() {
        ...
        sep(c -> {
            groupBy(KeyedData::getId, KeyedData::getAmount)
                    .innerJoin(groupBy(String::toString))
                    .mapValues(EventStreamBuildTest::mergedTypeFromTuple)
                    .map(GroupBy::toMap)
                    .sink("merged");
        });
    ...
    public void abstractAggregateFlowFunctionTest() {
        ...
        sep(c -> {
            groupBy(Data3::getName, Data3ToSum::new)
