...
public class JoinTest extends MultipleSepTargetInProcessTest {
    ...
    public void innerJoinTest() {
        sep(c -> {
                    GroupByFlowBuilder<String, School> schools = DataFlowBuilder.subscribe(School.class)
                            .groupBy(School::getName);
                    val pupils = DataFlowBuilder.subscribe(Pupil.class)
    ...
    public void leftJoinTest() {
        sep(c -> {
                    val schools = DataFlowBuilder.subscribe(School.class)
                            .groupBy(School::getName);
