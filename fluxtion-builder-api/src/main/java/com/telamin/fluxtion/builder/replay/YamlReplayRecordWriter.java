...
/**
 * Added as an {@link Auditor} to an CloneableDataFlow will trap all events and translate to yaml and push the result to
 * a registered reader.
 * <p>
 ...
 *
 * <pre>
 * CloneableDataFlow sep = new MyEventProcessor();;
 * //record audit log
...
public class YamlReplayRecordWriter implements Auditor {
    ...
    private final transient Yaml yaml = ReplayYamlFactory.newYaml();
