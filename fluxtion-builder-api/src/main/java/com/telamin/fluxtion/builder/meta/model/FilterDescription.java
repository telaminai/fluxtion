...
public class FilterDescription implements java.io.Serializable {
    ...
    public FilterDescription(String eventClassName, int value) {
        this.value = value;
        this.eventClass = null;
        this.stringValue = "";
        this.isIntFilter = true;
    ...
    public FilterDescription(String eventClassName, String value) {
    ...
    public FilterDescription(Class<? extends Event> eventClass) {
        ...
        this.isFiltered = false;
        this.nullId = "";
        this.eventClassName = eventClass == null ? null : eventClass.getCanonicalName();
    }
    ...
    public FilterDescription changeClass(String newClassName) {
        FilterDescription fd = new FilterDescription(newClassName, getStringValue());
        if (!isFiltered()) {
            fd = new FilterDescription(newClassName);
        } else if (isIntFilter()) {
            fd = new FilterDescription(newClassName, getValue());
        } else if (NO_FILTER.equals(this)) {
            return NO_FILTER;
        } else if (INVERSE_FILTER.equals(this)) {
            return INVERSE_FILTER;
        } else if (DEFAULT_FILTER.equals(this)) {
    ...
    public Class<? extends Event> getEventClass() {
        if (eventClass == null && eventClassName != null) {
            try {
                ...
                // class not available in this JVM - leave null
            }
        }
        return eventClass;
    }
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + Objects.hashCode(this.nullId);
        hash = 89 * hash + Objects.hashCode(this.eventClassName);
        return hash;
    }
