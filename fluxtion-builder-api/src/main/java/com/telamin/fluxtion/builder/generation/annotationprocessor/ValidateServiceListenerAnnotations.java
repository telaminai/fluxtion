        ...
        for (TypeElement annotation : annotations) {
            ...
            typeElements.forEach(element ->
                    processingEnv.getMessager().printMessage(Diagnostic.Kind.ERROR,
                            "[fluxtion-substrate-lint] service listener method must be public,"
                                    + " return void, and accept a single argument"
                                    + " (or a second optional CharSequence service-name argument)."
